https://voz.vn/t/huong-dan-dung-cloudflare-zero-trust.822971/page-72#post-28353836
- Thêm dòng cuối cùng vào file .yml
```
- uses: gautamkrishnar/keepalive-workflow@v1
```

- Canh làm sao dòng đó phải thẳng hàng với các dòng có dấu - ở trên vd
```
